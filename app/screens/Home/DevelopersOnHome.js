...
export class DevelopersOnHome extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
    ...
    renderDevelopersCard = () => {
        return (
            <View style={[styles.cardView, { marginVertical: verticalScale(40) }]}>
                <Text style={styles.cardHeadingText}>developers</Text>
    ...
    renderMoreContainer = () => {
        return (
            <Animatable.View animation="bounceInDown">
                <View style={!this.state.showViewModal ? [styles.extendedCardView, { marginVertical: verticalScale(60), borderRadius: scale(10) }] : [styles.extendedCardView, { marginVertical: verticalScale(60), borderTopLeftRadius: scale(10), borderTopRightRadius: scale(10) }]}>
                    ...
                    {!this.state.showViewModal ?
                        <>
                            <View style={{ paddingHorizontal: scale(27), paddingVertical: scale(29) }}>
                                <Text style={[styles.cardHeadingText, { color: '#fff' }]}>developers</Text>
    ...
    render() {
        return (
            <View>
                {!this.state.exploreMore && this.renderDevelopersCard()}
                <View style={{ borderRadius: scale(10) }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(DevelopersOnHome);